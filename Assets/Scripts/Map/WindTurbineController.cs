...
public class WindTurbineController : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusHandler
{
    ...
    public void GetTurbineData(WindTurbineScriptableObject wt)
    {
        Debug.Log("her");
        turbineData.windTurbineData.RotorSpeed = wt.windTurbineData.RotorSpeed;
        Debug.Log(turbineData.windTurbineData.RotorSpeed);
    ...
    private void Start()
    {
        ...
        turbineMeshes = GetComponentsInChildren<MeshRenderer>()
            ...
            .ToArray();
        //turbineData.windTurbineData.RotorSpeed = 50;
        /*(if (turbineData)
        {
            SetTurbineData(turbineData);
        }*/
    ...
    private void Update()
    {
        //turbineData.windTurbineData.RotorSpeed += Time.deltaTime;
        SetTurbineData(turbineData);
        if (!turbineData)
            return;
